...
//     },
// };
export function CompraCreadaUsuarioLolaEmail({ orden }: ICompraCreadaUsuarioLolaEmailProps) {
                ...
                <Container className="mb-8 text-start">
                    <Heading as="h3" className="flex gap-2 text-sm font-thin">
                        <Img
                            ...
                            width={20}
                        />
                        El paquete sera recolectado{' '}
                        <strong className="font-semibold">{detalles.tiempoRecoleccion}</strong>.
                    </Heading>
...
export default CompraCreadaUsuarioLolaEmail;
